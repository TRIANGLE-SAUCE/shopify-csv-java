...
class CustomerCsvFactoryTest {
	...
	void createCsv() throws Exception {
		...
		Assertions.assertThat(factory.create(Collections.singletonList(customerCsv)))
				.isEqualTo(
						"\"First Name\",\"Last Name\",Email,Company,Address1,Address2,City,Province,\"Province Code\",Country,\"Country Code\",Zip,Phone,\"Accepts Marketing\",Tags,Note,\"Tax Exempt\"\n" +
								"Taro,Tanaka,test@triangle-sauce.com,\"build&scrap,inc\",\"1-11-17 Ebisu\",,\"Shibuya Ward\",Tokyo,13,Japan,JP,150-0022,1234567,no,\"tag1,tag2,tag3\",triangle-sauce,no\n");
	}
